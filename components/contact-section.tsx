  ...
  return (
    <section className="py-16 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        <h2 className="text-3xl md:text-4xl font-bold text-clinical-700 mb-10">Entre em Contato:</h2>

        <div className="max-w-4xl">
          {/* Address with Map */}
          <div className="flex items-start gap-3 mb-8">
            <MapPin size={24} className="text-clinical-500 flex-shrink-0 mt-1" />
            <div>
          ...
          <div className="space-y-4 mb-8">
            ...
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full border border-clinical-500 flex items-center justify-center">
                <svg
                  ...
                  className="text-clinical-500"
                >
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                </svg>
              </div>
              <a href="tel:5135927824" className="text-clinical-500 text-lg hover:underline">
                (51) 3592-7824
              </a>
            </div>
            ...
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full border border-clinical-500 flex items-center justify-center">
                <div className="relative w-5 h-5 text-clinical-500">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
              ...
              <a
                ...
                className="text-clinical-500 text-lg hover:underline"
              >
                (51) 992997401
              </a>
            </div>
          ...
          {/* Social Media */}
          <div>
            <h3 className="text-xl font-semibold text-clinical-500 mb-4">ACOMPANHE NAS REDES:</h3>
            <div className="flex gap-4">
              <Link
                href="#"
                className="w-12 h-12 rounded-full border border-clinical-500 text-clinical-500 flex items-center justify-center hover:bg-clinical-500 hover:text-white transition-colors"
                aria-label="Facebook"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
