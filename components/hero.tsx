      ...
      <div className="w-full h-[600px] relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-clinical-700/70 to-transparent flex items-center z-10">
          <div className="container mx-auto px-4">
            <div className="max-w-xl text-white">
              <h1 className="text-4xl md:text-5xl font-bold mb-4 animate-fadeIn">BIOSTHETICS</h1>
              <p className="text-xl mb-6 animate-fadeIn animation-delay-300">Odontologia Estética e Restauradora</p>
            </div>
          </div>
        </div>
        ...
        <div className="absolute bottom-10 left-0 right-0 flex justify-center z-20">
          <a
            ...
            className="flex items-center gap-2 bg-clinical-500 hover:bg-clinical-600 text-white px-4 py-2.5 rounded-md transition-colors shadow-md"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 1219.547 1225.016" fill="white">
