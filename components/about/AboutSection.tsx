    ...
    <section className="py-16 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="prose prose-lg max-w-none">
                <p className="text-xl leading-relaxed text-gray-700 mb-6">
                  ...
                  Bioesthetics, cada detalhe importa — da saúde bucal à harmonia facial.
                </p>
            ...
            <div className="relative">
              <div className="relative h-96 sm:h-[500px] lg:h-[600px] rounded-lg overflow-hidden shadow-xl">
                <Image
                  src="/images/logo.png"
                  alt="Bioesthetics - Clínica Odontológica"
                  fill
          ...
          {/* Features Grid */}
          <div className="mt-20">
            <h3 className="text-3xl font-bold text-primary-500 text-center mb-12">Por que escolher a Bioesthetics?</h3>
